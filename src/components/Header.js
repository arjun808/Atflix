...
function Header() {
  ...
  return (
    <div className='absolute top-0 left-0 w-full px-8 py-2 bg-gradient-to-b from-black via-transparent to-transparent z-50 flex justify-between items-center'>
